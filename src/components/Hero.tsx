    ...
    >
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-10 items-center">
        ...
        <div className="lg:col-span-7">
          ...
          <motion.div {...fadeUp(0)} className="mb-8">
            <span className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs font-mono text-slate-300 select-none">
          ...
          <motion.h1
            {...fadeUp(0.08)}
            className="text-[clamp(3.5rem,10vw,8.5rem)] font-extrabold tracking-tighter text-white leading-[0.9] mb-7"
          >
          ...
          <motion.p
            {...fadeUp(0.26)}
            className="text-base md:text-lg font-mono text-indigo-300 font-medium mb-5"
          >
          ...
          <motion.div
            ...
            className="flex flex-wrap gap-5 pt-6 border-t border-white/10 text-xs font-mono text-slate-500"
          >
            {[
      ...
      >
        ...
        <div className="w-5 h-8 rounded-full border border-slate-700 p-1 flex justify-center">
          <div className="w-1 h-2 bg-blue-500/70 rounded-full animate-bounce" />
        </div>
      </motion.div>
    </section>
  );
