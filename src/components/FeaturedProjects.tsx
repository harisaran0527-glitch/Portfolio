...
// ── Single featured project row with 3D Card Tilt ──────────────────────────
  ...
  return (
    ...
    >
      <div
        ...
        className="group relative rounded-2xl bg-[#080a14]/90 border border-white/12 overflow-hidden hover:border-blue-500/40 transition-colors duration-500 shadow-2xl glass-panel-hover"
      >
          ...
          <div className={`lg:col-span-5 p-8 sm:p-10 lg:p-12 flex flex-col justify-between ${isEven ? '' : 'lg:[direction:ltr]'}`}>
            ...
            <div className="mt-10">
              <button
                ...
                onClick={onSelect}
                className="btn-magnetic btn-shine w-full sm:w-auto px-7 py-3.5 rounded-xl border border-white/15 bg-white/5 hover:bg-white hover:text-black text-white font-semibold text-sm transition-all duration-300 flex items-center justify-center gap-2"
              >
